...
class DifficultyScaleRangeController(service: DifficultyScaleRangeService) : AbstractCRUDController<DifficultyScaleRange, DifficultyScaleRangeRepository, DifficultyScaleRangePatchDTO, DifficultyScaleRangeFullDTO, DifficultyScaleRangeSearchDTO>(service)
